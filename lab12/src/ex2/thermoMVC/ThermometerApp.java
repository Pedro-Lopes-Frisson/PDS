...
public class ThermometerApp {
	...
	public static void main(String[] args) {
		...
		ConsoleDisplay consoleDisplay = new ConsoleDisplay(thermometer);
		
		
		// Add the views to the display
		mainPanel.add(thermometerDisplay);
		mainPanel.add(thermometerDisplay2);
		mainPanel.add(consoleDisplay);
		
		// Get the views to listen to the model
		thermometer.addThermometerListener( (ThermometerListener) thermometerDisplay );
		thermometer.addThermometerListener( (ThermometerListener) thermometerDisplay2 );
		thermometer.addThermometerListener( (ThermometerListener) consoleDisplay );
